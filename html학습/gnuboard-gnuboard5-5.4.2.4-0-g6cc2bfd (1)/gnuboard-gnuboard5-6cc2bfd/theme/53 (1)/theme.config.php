...
$theme_config = array(
	...
	'de_listtype_list_mod'			=> 4,		// PC 유형별 상품리스트 1줄당 이미지 수
	'de_listtype_list_row'			=> 5,		// PC 유형별 상품리스트 1줄당 출력할 줄 수
	'de_mobile_listtype_list_mod'	=> 3,		// MOBILE 유형별 상품리스트 1줄당 이미지 수
	'de_mobile_listtype_list_row'	=> 5,		// MOBILE 유형별 상품리스트 1줄당 출력할 줄 수
	'de_listtype_img_width'			=> 230,		// PC 유형별 상품리스트 이미지 width
	'de_listtype_img_height'		=> 230,		// PC 유형별 상품리스트 이미지 height
	'de_mobile_listtype_img_width'  => 230,		// MOBILE 유형별 상품리스트 이미지 width
	'de_mobile_listtype_img_height' => 230,		// MOBILE 유형별 상품리스트 이미지 height
);
?>